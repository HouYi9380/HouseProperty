...
(/** @lends <global> */function( $ ) {
	...
	DataTable.defaults = {
		 ...
		 * slightly different and additional AdminEx-up from what DataTables has
		 * traditionally used).
		 *  @type boolean
		 *  @default false
		 *  @dtopt Features
		...
		"oLanguage": {
			 ...
			 *    } );
			 */
			"sInfo": "从第 _START_ 条到 _END_ 条  共 _TOTAL_ 条",
